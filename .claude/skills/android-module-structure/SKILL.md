...
| `android-feature` | Android library + Compose + Hilt + shared feature deps bundled |
| `domain-module` | Pure Kotlin/KMP module, no Android deps |
| `compose` | Compose compiler + BOM |
| `hilt` | Hilt plugin + KSP compiler + dependencies |
...
| Navigation | Navigation 3 (`NavKey` routes + `NavDisplay`) |
